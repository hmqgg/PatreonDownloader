...
namespace PatreonDownloader.Engine.Models.JSONObjects.Campaign
{
    ...
    {
        [JsonProperty("avatar_photo_url")] public string AvatarUrl;

        [JsonProperty("cover_photo_url")] public string CoverUrl;
    ...
    public class Data
    {
        [JsonProperty("attributes")] public Attributes Attributes;
    }
