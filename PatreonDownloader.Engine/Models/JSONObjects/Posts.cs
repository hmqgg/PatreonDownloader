...
namespace PatreonDownloader.Engine.Models.JSONObjects.Posts
{
    public class Embed
    {
        ...
        [JsonProperty("html")] public object Html { get; set; }
    ...
    public class Image
    {
        ...
        [JsonProperty("large_url")] public string LargeUrl { get; set; }
    ...
    {
        [JsonProperty("change_visibility_at")] public object ChangeVisibilityAt { get; set; }
        ...
        [JsonProperty("patreon_url")] public string PatreonUrl { get; set; }

        [JsonProperty("patron_count")] public int? PatronCount { get; set; }

        [JsonProperty("pledge_url")] public string PledgeUrl { get; set; }

        [JsonProperty("post_file")] public PostFile PostFile { get; set; }

        [JsonProperty("post_metadata")] public object PostMetadata { get; set; }

        [JsonProperty("post_type")] public string PostType { get; set; }

        [JsonProperty("published_at")] public DateTime PublishedAt { get; set; }

        [JsonProperty("teaser_text")] public object TeaserText { get; set; }

        [JsonProperty("title")] public string Title { get; set; }

        [JsonProperty("upgrade_url")] public string UpgradeUrl { get; set; }
    ...
    public class Campaign
    {
        ...
        [JsonProperty("links")] public CampaignLinks Links { get; set; }
    }
    ...
    {
        [JsonProperty("data")] public List<object> Data { get; set; }
    }

    public class RootDataRelationships
    {
        [JsonProperty("access_rules")] public AccessRules AccessRules { get; set; }

        [JsonProperty("attachments")] public Attachments Attachments { get; set; }

        [JsonProperty("audio")] public Audio Audio { get; set; }

        [JsonProperty("campaign")] public Campaign Campaign { get; set; }
        ...
        [JsonProperty("user_defined_tags")] public UserDefinedTags UserDefinedTags { get; set; }
    }

    public class RootData
    {
        [JsonProperty("attributes")] public RootDataAttributes Attributes { get; set; }

        [JsonProperty("id")] public string Id { get; set; }

        [JsonProperty("relationships")] public RootDataRelationships Relationships { get; set; }
    ...
    public class IncludedAttributes
    {
        ...
        [JsonProperty("avatar_photo_url")] public string AvatarPhotoUrl { get; set; }

        [JsonProperty("earnings_visibility")] public string EarningsVisibility { get; set; }

        [JsonProperty("is_monthly")] public bool? IsMonthly { get; set; }
        ...
        [JsonProperty("access_rule_type")] public string AccessRuleType { get; set; }

        [JsonProperty("amount_cents")] public object AmountCents { get; set; }
    ...
    public class Root
    {
        [JsonProperty("data")] public List<RootData> Data { get; set; }

        [JsonProperty("included")] public List<Included> Included { get; set; }

        [JsonProperty("links")] public RootLinks Links { get; set; }
