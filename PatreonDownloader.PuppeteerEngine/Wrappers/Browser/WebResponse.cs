...
{
    /// <summary>
    ///     This class is a wrapper around a Puppeteer Sharp's response object used to implement proper dependency injection
    ///     mechanism
    ...
    public sealed class WebResponse : IWebResponse
    {
        ...
        public HttpStatusCode Status => _response.Status;
